<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="ContractorPage.Login" %>
...
<body style="height: 362px;background-color:whitesmoke" >
    ...
    <div>
        <table>
            ...
            <tr>
                <td></td>
                <td class="auto-style3"><img src="Images/demo1_header.gif" style="height:130px; width:1038px" /></td>
            </tr>
            <tr>
                 <td></td>
                 <td align="center" style="font-weight:700" class="auto-style3">Please Enter User Name & Password Below</td>
                 <td></td>
           </tr>
        </table>
